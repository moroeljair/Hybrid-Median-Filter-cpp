...
vector<vector<element>> hybridmedianfilterN2(vector<vector<element>> image, int MN_vecindad=1);
...
vector<vector<element>> hybridmedianfilterN2(vector<vector<element>> image, int MN_vecindad)
{
